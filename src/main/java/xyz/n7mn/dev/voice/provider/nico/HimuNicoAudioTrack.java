...
public class HimuNicoAudioTrack extends DelegatedAudioTrack {
    private static final Logger log = LoggerFactory.getLogger(NicoAudioTrack.class);
    protected final HimuNicoAudioSourceManager sourceManager;
     ...
     */
    public HimuNicoAudioTrack(AudioTrackInfo trackInfo, HimuNicoAudioSourceManager sourceManager) {
        super(trackInfo);
    ...
    protected AudioTrack makeShallowClone() {
        return new HimuNicoAudioTrack(trackInfo, sourceManager);
    }
}
